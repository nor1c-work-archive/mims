			...
			<div class="modal-body">
				<form id="advancedFilterForm" class="form-horizontal r-separator" onkeydown="return event.key != 'Enter';" method="post" action="#">
					<div class="card-body">
						...
						<!-- <div class="form-group row align-items-center mb-0">
                        <label for="inputEmail3" class="col-4 control-label col-form-label">TANGGAL INPUT</label>
                        <div class="col-8 border-left pb-2 pt-2" style="display:inline-block">
                            <input type="text" style="width:40%;float:left;" class="form-control mydatepicker" name="firstProcureDate" placeholder="Tanggal Awal" autocomplete="off">
                            <span style="float:left;margin-top:3px;padding:5px;">sampai</span>
                            <input type="text" style="width:40%;" class="form-control mydatepicker" name="lastProcureDate" placeholder="Tanggal Akhir" autocomplete="off">
                        </div>
                    </div> -->
